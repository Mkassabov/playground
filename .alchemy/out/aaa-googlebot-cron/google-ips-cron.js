...
// src/cron/google-ips-cron.ts
var google_ips_cron_default = {
  // biome-ignore lint/suspicious/useAwait: its fine
  async fetch() {
    const id2 = id();
    const message = `Haiii - patpat2! ${id2}`;
    console.log(message);
    return new Response(message);
  }
};
export {
  google_ips_cron_default as default
};
//# sourceMappingURL=google-ips-cron.js.map
