...
// deployments/alchemy-worker/src/taptap.ts
import { WorkerEntrypoint } from "cloudflare:workers";
var taptap_default = {
  // biome-ignore lint/suspicious/useAwait: its fine
  async fetch() {
    const id2 = id();
    const message = `Haiii - taptap! ${id2}`;
    console.log(message);
    return new Response(message);
  }
};
var TapTapEntrypoint = class extends WorkerEntrypoint {
  static {
    __name(this, "TapTapEntrypoint");
  }
  // biome-ignore lint/suspicious/useAwait: its fine
  async tap() {
...
export {
  TapTapEntrypoint,
  taptap_default as default
};
//# sourceMappingURL=taptap.js.map
